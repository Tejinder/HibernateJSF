...
import com.jsfhibernate.pojo.Thesis;
...
public class DatabaseOperations {
	...
	public void addThesisInDb(Thesis thesisObj) {		
		try {
			...
			System.out.println("Thesis Record With Id: " + thesisObj.getId() + " Is Successfully Created In Database");

			// XHTML Response Text
			//FacesContext.getCurrentInstance().getExternalContext().getSessionMap().put("createdThesisId",  thesisObj.getId());						
			FacesContext.getCurrentInstance().getExternalContext().getRequestMap().put("createdThesisId",  thesisObj.getId());
